...
### Changed
- **Version Update**: Bumped package version from 1.1.4 to 1.2.0
- **Dependency Update**: Upgraded Cobilas.Godot.Utility from version 7.1.1 to 7.3.2
- **Resource Management**: Enhanced disposal mechanism in InternalComponentHub for better memory management

### Fixed
- **Memory Management**: Improved component cleanup in InternalComponentHub.Dispose method using ArrayManipulation.ClearArraySafe
- **Parent Component Handling**: Fixed parent component removal during disposal to prevent reference leaks

### Technical Notes
- The updated disposal pattern ensures proper cleanup of component arrays and prevents memory leaks
- ArrayManipulation.ClearArraySafe provides safer array clearing with null reference handling
